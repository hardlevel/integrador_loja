async function main(config){
	...
	const getProductDetails = async () => {
		...
		for(const item of data){
			...
			item.width = itemProduct.largura;
			item.weight = itemProduct.peso;
			item.height = itemProduct.altura;
			item.depth = itemProduct.profundidade;
			...
			item.categoryName = categoriesNames;

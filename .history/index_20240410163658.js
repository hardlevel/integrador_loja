...
async function main() {
	...
	const descritores = Object.getOwnPropertyDescriptors(controller);

	for (const metodo in descritores) {
		if (descritores[metodo].value && typeof descritores[metodo].value === 'function') {
			console.log(metodo);
		}
	}
